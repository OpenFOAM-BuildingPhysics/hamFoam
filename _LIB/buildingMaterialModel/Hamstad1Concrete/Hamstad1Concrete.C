...
{
    defineTypeNameAndDebug(Hamstad1Concrete, 0);
...
Foam::buildingMaterialModels::Hamstad1Concrete::Hamstad1Concrete
(
    const word& name,
...
void Foam::buildingMaterialModels::Hamstad1Concrete::update_w_C_cell(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label& celli)
{
...
void Foam::buildingMaterialModels::Hamstad1Concrete::update_Krel_cell(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label& celli)
{
...
void Foam::buildingMaterialModels::Hamstad1Concrete::update_Kvap_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, volScalarField& K_pt, label& celli)
