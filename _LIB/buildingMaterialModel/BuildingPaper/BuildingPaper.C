...
{
    defineTypeNameAndDebug(BuildingPaper, 0);
...
Foam::buildingMaterialModels::BuildingPaper::BuildingPaper
(
    const word& name,
...
void Foam::buildingMaterialModels::BuildingPaper::update_Kvap_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, volScalarField& K_pt, label& celli)
