...
{
    defineTypeNameAndDebug(Hamstad4Plaster, 0);
...
Foam::buildingMaterialModels::Hamstad4Plaster::Hamstad4Plaster
(
    const word& name,
...
void Foam::buildingMaterialModels::Hamstad4Plaster::update_w_C_cell(const volScalarField& pc, volScalarField& w, volScalarField& Crel, label& celli)
{
...
void Foam::buildingMaterialModels::Hamstad4Plaster::update_Krel_cell(const volScalarField& pc, const volScalarField& w, volScalarField& Krel, label& celli)
{
...
void Foam::buildingMaterialModels::Hamstad4Plaster::update_Kvap_cell(const volScalarField& pc, const volScalarField& w, const volScalarField& T, volScalarField& K_v, volScalarField& K_pt, label& celli)
{
    scalar rho_l = 1.0e3; 
